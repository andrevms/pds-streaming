    ...
    return (
        <div className="header">
            ...
            <div className="header-buttons">
                <button className="header-button"><Link className="header-navbar-link" to="/catalog/all">Em destaque</Link></button>
                <button className="header-button"><Link className="header-navbar-link" to="/catalog/all">Séries</Link></button>
                <button className="header-button"><Link className="header-navbar-link" to="/catalog/all">Filmes</Link></button>
