...
import br.com.pds.streaming.media.model.dto.StarRatingDTO;
import br.com.pds.streaming.media.model.entities.Rating;
import br.com.pds.streaming.media.model.entities.StarRating;
import br.com.pds.streaming.media.repositories.StarRatingRepository;
...
public class StarRatingService {
    ...
    @Autowired
    public StarRatingService(StarRatingRepository starRatingRepository, UserRepository userRepository, MyModelMapper mapper) {
