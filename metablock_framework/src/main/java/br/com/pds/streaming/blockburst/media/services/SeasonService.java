...
public class SeasonService {
    ...
    @Autowired
    public SeasonService(SeasonRepository seasonRepository, TvShowRepository tvShowRepository, EpisodeRepository episodeRepository, BlockburstMapper mapper, CloudStorageService cloudStorageService) {
    ...
    private void deleteOrphanEpisodes(String seasonId) {
        episodeRepository.deleteAll(episodeRepository.findBySeasonId(seasonId));
    }
